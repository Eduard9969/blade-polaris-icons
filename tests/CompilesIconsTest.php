...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('cartabandonedicon.svg')->toHtml();
    ...
    {
        $result = svg('cartabandonedicon.svg', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('cartabandonedicon.svg', ['style' => 'color: #555'])->toHtml();
